...
START_TEST(s21_strncat_1) {
        ...
        ck_assert_str_eq(s21_strncat(str_dest_as,str_src, 100), strncat(str_dest_eq,str_src,100));
...
START_TEST(s21_strncat_2) {
    ...
    char str_dest_eq[100] = "Hello";
    const char str_src[] = " World";
    ck_assert_str_eq(s21_strncat(str_dest_as,str_src, 2), strncat(str_dest_eq,str_src,2));
...
START_TEST(s21_strncat_3) {
    ...
    char str_dest_eq[100] = "Hello";
    const char str_src[] = " World";
    ck_assert_str_eq(s21_strncat(str_dest_as,str_src, 0), strncat(str_dest_eq,str_src,0));
...
START_TEST(s21_strncat_4) {
    ...
    ck_assert_str_eq(s21_strncat(str_dest_as,str_src,3), strncat(str_dest_eq,str_src,3));
} END_TEST
...
START_TEST(s21_strncat_5) {
    ...
    ck_assert_str_eq(s21_strncat(str_dest_as,str_src,1), strncat(str_dest_eq,str_src,1));
} END_TEST
...
START_TEST(s21_strncat_6) {
    ...
    char str_dest_eq[100] = "Hello";
    const char str_src[] = "\0";
    ck_assert_str_eq(s21_strncat(str_dest_as,str_src,5), strncat(str_dest_eq,str_src,5));
} END_TEST
