...
START_TEST(s21_strncpy_1) {
        char src[10] = "Hello";
        char dest_ac[10]; s21_strncpy(dest_ac,src,10);
        char dest_ex[10]; strncpy(dest_ex,src,10);
...
START_TEST(s21_strncpy_2) {
    char src[10] = "";
    char dest_ac[10]; s21_strncpy(dest_ac,src,1);
    char dest_ex[10]; strncpy(dest_ex,src,1);
...
START_TEST(s21_strncpy_4) {
    char* src = "\n\n\n\n\n\n";
    char dest_ac[10]; s21_strncpy(dest_ac,src,3);
    char dest_ex[10]; strncpy(dest_ex,src,3);
